HAP1 with GPSeq at 100 kb
-------------------------

.. warning:: The code examples in this section contain references to scripts that re not available in the chromflock repo. To be updated.

This can be done on a system with 32 GB but will kill a system with 16
GB of ram (or use a lot of swapping).
...
::
   ...
   mkdir 1000
   cd 1000
   chromflock hic2cpm --hfile ../4DNFI1E6NJQJ.hic.H_trans.double --lfile ../4DNFI1E6NJQJ.hic.H_trans.L.uint8 --nCont 8 --nStruct 1000
